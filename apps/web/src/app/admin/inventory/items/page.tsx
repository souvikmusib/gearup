...
export default function InventoryItemsPage() {
  ...
  const columns = [
    ...
    { key: 'discountedPrice', header: 'Price', render: (r: any) => { const dp = Number(r.discountPercent) || 0; const price = Number(r.sellingPrice) * (1 - dp / 100); return dp ? `₹${price.toFixed(0)} (${dp}% off)` : `₹${Number(r.sellingPrice)}`; } },
