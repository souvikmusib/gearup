...
export default function CustomerDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal open={showDelete} onClose={() => setShowDelete(false)} title="Delete Customer">
        <div className="space-y-4">
          <p className="text-sm text-gray-700 dark:text-gray-300">Are you sure you want to delete <span className="font-semibold">{data.fullName}</span>? This action cannot be undone.</p>
          <div className="flex justify-end gap-2">
            ...
            <button
              onClick={async () => {
                ...
                setDeleting(false);
                if (res.success) router.push('/admin/customers');
