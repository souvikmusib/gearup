...
- id: `expense-list-no-date-filter` · category: business-logic
- location: `apps/web/src/app/api/admin/expenses/route.ts:13`
- evidence:
```
...
- proposed fix: Accept from/to and apply expenseDate range, matching the report route.